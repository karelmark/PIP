<%@ Page Language="VB" AutoEventWireup="false" CodeFile="forstudyadmin.aspx.vb" Inherits="allforstudydmin" %>
...
<div id="header">
    ...
    <div id="buttons">
        <ul>
          ...
          <li><a href="user.aspx" title="">logout</a></li>
		...
		<div class="wrapper" style="left: 0px; top: 0px; height: 726px">
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="pip_approvedby" HeaderText="Approvedby" SortExpression="pip_approvedby" />
            ...
            <asp:ScriptManager id="ScriptManager1" runat="server">
                ...
                <ContentTemplate>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                        SelectCommand="SELECT * FROM [pip_data] where [pip_status] = 'FOR STUDY' AND pip_loginid =@pip_loginid">
