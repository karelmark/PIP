<%@ Page Language="VB" AutoEventWireup="false" CodeFile="allstudyadmin.aspx.vb" Inherits="allpendingadmin" %>
...
<!-- header ends -->
    ...
    <div id="cont_bot"></div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:pip_systemConnectionString19 %>"
            ...
            SelectCommand="SELECT [pip_no], [pip_loginid], [pip_department], [pip_status], [pip_remarks], [pip_reason], [pip_month] FROM [pip_data]where [pip_status] = 'FOR STUDY'"
