...
Partial Class evaluatevalidrec
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        conn.Open()
        str4 = "update pip_data set pip_status2 = '" & "REJECTED-" & "'," & _
        "pip_status1 = '" & "REJECTED-" & "'," & _
        "pip_status3 = '" & "REJECTED-" & "'," & _
        "pip_status = '" & "DISAPPROVED" & "'," & _
        "pip_remarks2 = '" & TextBox2.Text & "'where pip_no = '" & Label10.Text & "'"
    ...
    Public Sub AUTO_EMAIL_REJECT()
        ...
        Dim strSubject As String = "2nd Level Evaluation REJECTED!"
    ...
    End Sub
    Public Sub AUTO_EMAIL_2PIPCOM_QA_PROP()
        ...
        'proponent of the entry
        Dim strCC As String = Label16.Text + "," + Label18.Text

        ' Dim strBCC As String = "cde5@pqr3.com,cdew@pqrw.com"
        Dim strPeriority As String = "High"
        ' Dim strAttachment As String = "C:\parent screen.jpg,C:\Print Screen.jpg"
        Dim strSubject As String = "2nd Level Evaluation APPROVED!"
    ...
    End Sub
    Public Sub con_pipcom()

        conn.Open()
        str = ("select * from pip_committee ")
        ...
        If dr.Read() = True Then
            ...
            Label9.Text = dr("pipcom").ToString()
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        conn.Open()
        str4 = "update pip_data set pip_status2 = '" & "ACCEPTED-" & "'," & _
         "pip_status1 = '" & "ACCEPTED-" & "'," & _
        "pip_status3 = '" & "ACCEPTED-" & "'," & _
        "pip_remarks2 = '" & TextBox2.Text & "' where pip_no = '" & Label10.Text & "'"
        com = New SqlCommand(str4, conn)
        com.ExecuteNonQuery()
        conn.Close()
    ...
    Private Sub showrecordfile()
        ...
        str = ("select pip_department,pip_no, pip_loginid,pip_suggest,pip_savings,pip_status1,pip_remarks,pip_reason,convert(varchar(8),pip_date,1) as pip_date,pip_time,pip_recordno,pip_plant,pip_area from pip_data where pip_no ='" & Session("pip_no") & "'")
        cmd = New SqlCommand(Str, conn)
        dr = cmd.ExecuteReader()
