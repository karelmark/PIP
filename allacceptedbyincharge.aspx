<%@ Page Language="VB" AutoEventWireup="false" CodeFile="allacceptedbyincharge.aspx.vb" Inherits="allpendingadmin" %>
            ...
            <asp:ScriptManager id="ScriptManager1" runat="server">
                ...
                <ContentTemplate>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                        SelectCommand="SELECT * FROM [pip_data] where [pip_status1] = 'ACCEPTED' order by [pip_no] desc"  >
