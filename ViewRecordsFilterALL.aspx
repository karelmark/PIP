<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewRecordsFilterALL.aspx.vb" Inherits="ViewRecordsFilterALL" %>
            ...
            <strong><span style="font-family: Arial">
                ...
                &nbsp;<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="pip_date" HeaderText="DATE" SortExpression="pip_date" DataFormatString="{0:d}" HtmlEncode="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:pip_systemConnectionString5 %>"
                    SelectCommand="SELECT [pip_loginid], [pip_no], [pip_department], [pip_suggest], [pip_savings], [pip_remarks], [pip_reason], [pip_date], [pip_approvedby] FROM [pip_data] WHERE (([pip_date] >= @pip_date) AND ([pip_date] <= @pip_date2) AND ([pip_status] = @pip_status))">
                    <SelectParameters>
