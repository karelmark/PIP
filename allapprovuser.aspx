<%@ Page Language="VB" AutoEventWireup="false" CodeFile="allapprovuser.aspx.vb" Inherits="allapprovuser" %>
            ...
            <asp:ScriptManager id="ScriptManager1" runat="server">
                ...
                <ContentTemplate>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                        SelectCommand="SELECT * FROM [pip_data] where [pip_status] = 'APPROVED' AND pip_loginid =@pip_loginid" >
