<%@ Page Language="VB" AutoEventWireup="false" CodeFile="allfinaladmin.aspx.vb" Inherits="allpendingadmin" %>
		...
		<div class="wrapper" style="left: 0px; top: 0px; height: 726px">
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="pip_status1" HeaderText="Status(by GSS)" SortExpression="pip_status1" />
                      <asp:BoundField DataField="pip_status2" HeaderText="Status(by Dept.In-charge))" SortExpression="pip_status2" />
            ...
            <asp:ScriptManager id="ScriptManager1" runat="server">
                ...
                <ContentTemplate>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                        SelectCommand="SELECT * FROM [pip_data] where [pip_status3]='ACCEPTED-' or pip_status3 ='REJECTED-' order by [pip_no] desc"  >
