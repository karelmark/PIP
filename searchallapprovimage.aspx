<%@ Page Language="VB" AutoEventWireup="false" CodeFile="searchallapprovimage.aspx.vb" Inherits="image" %>
    ...
    <div id="content">
		...
		<div class="wrapper">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                ...
                DataSourceID="SqlDataSource1" Height="164px" Style="font-size: 8pt; left: 74px;
            ...
            <ItemTemplate>
             <asp:ImageButton ID="ibDownload" runat="server" CommandName="Download" CommandArgument='<%# Bind("imageurl") %>' />
            </ItemTemplate>
            </asp:TemplateField>
