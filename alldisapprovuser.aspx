<%@ Page Language="VB" AutoEventWireup="false" CodeFile="alldisapprovuser.aspx.vb" Inherits="alldisapprovuser" %>
            ...
            <asp:ScriptManager id="ScriptManager1" runat="server">
                ...
                <ContentTemplate>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                        SelectCommand="SELECT * FROM [pip_data] where [pip_status] = 'DISAPPROVED' AND pip_loginid =@pip_loginid" >
