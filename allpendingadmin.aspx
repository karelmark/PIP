<%@ Page Language="VB" AutoEventWireup="false" CodeFile="allpendingadmin.aspx.vb" Inherits="allpendingadmin" %>
    ...
    <div id="content">
		...
		<div class="wrapper" style="left: 0px; top: 0px; height: 726px">
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                CellPadding="4" DataKeyNames="pip_no" DataSourceID="SqlDataSource1" Font-Size="Small" Style="left: 114px; position: absolute;
                top: 193px" Width="655px" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px">
            ...
            <asp:ScriptManager id="ScriptManager1" runat="server">
                ...
                <ContentTemplate>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                        SelectCommand="SELECT * FROM [pip_data] where [pip_status1] = 'PENDING' order by [pip_no] desc"  >
