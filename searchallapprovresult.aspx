<%@ Page Language="VB" AutoEventWireup="false" CodeFile="searchallapprovresult.aspx.vb" Inherits="evaluatevalid" %>
    ...
    <div id="content">
		...
		<div class="wrapper">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                ...
                Style="font-size: 8pt; left: 8px; font-family: Arial; position: relative; top: -254px"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="pip_date" DataFormatString="{0:M/dd/yyy}" HeaderText="Date Submitted"
            ...
            <asp:Button ID="Button1" runat="server" Style="left: 8px; position: relative; top: -254px"
                Text="Back" Width="69px" /><asp:SqlDataSource ID="SqlDataSource1" runat="server"
                    ConnectionString="<%$ ConnectionStrings:pip_systemConnectionString6 %>" SelectCommand="SELECT [pip_no], [pip_loginid], [pip_suggest], [pip_status], [pip_savings], [pip_date],[pip_department] FROM [pip_data] WHERE (([pip_date] >= @pip_date) AND ([pip_date] <= @pip_date2)AND ([pip_department] = @pip_department)AND ([pip_status] = 'APPROVED')) ORDER BY [pip_no]">
                    <SelectParameters>
